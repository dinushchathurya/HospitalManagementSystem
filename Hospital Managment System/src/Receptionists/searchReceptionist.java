...
public class searchReceptionist extends javax.swing.JFrame {
    ...
    public searchReceptionist() {
        ...
        Object columns[] = {"ID", "Joining Date","Name", "Age", "Gender", "Blood Group", "Email Address", "Phone Number", "Address", "Status", "Username"};
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select count,joining,name,age,gender,blood,email,phone,address,status,username from receptionist where name = '" + searchKey + "'";
        try {
