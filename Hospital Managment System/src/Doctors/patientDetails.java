...
public final class patientDetails extends javax.swing.JFrame {
    ...
    public patientDetails(String name) {
        ...
        data = name;
        Object columns[] = {"Count", "Date","Name", "Age", "Gender", "Address", "Phone Number", "Status", "Disease", "Room Number"};
    ...
    public void loadData() {
        ...
        String sql = "select count,date,name,age,gender,address,phone,status,disease,room from patient where name = '" + data + "'";
        try {
