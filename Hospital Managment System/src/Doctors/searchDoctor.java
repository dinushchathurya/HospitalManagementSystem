...
public class searchDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dSearchbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void dSearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dSearchbtnMouseClicked
        ...
        String sql = "select count,date,name,age,gender,blood,dept,phone,email,status,address,room,username from doctor where name = '" + searchKey + "'";
        try {
