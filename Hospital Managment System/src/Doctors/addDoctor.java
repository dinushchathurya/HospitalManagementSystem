...
public class addDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dStatusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Single", "Married" }));
    ...
    private void nextId() {
        connection = Connector.ConnectDb();
        if (connection != null) {
            String sql = "select `count`+1 as next_id from doctor order by `count` desc limit 1;";
            try {
                prp = connection.prepareStatement(sql);
                rs = prp.executeQuery();
                int nextId = 0;
                ...
                dIdField.setText(String.valueOf(nextId));
