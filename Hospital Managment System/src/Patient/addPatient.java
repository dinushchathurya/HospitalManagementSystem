...
public class addPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pStatusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Single", "Married", "Divorced" }));
        ...
        addDctorbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        clearPbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        clearPbtn.setBounds(20, 20, 55, 30);
    ...
    private void addDctorbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDctorbtnMouseClicked
        ...
        if (connection != null) {
            ...
            String sql = "insert into patient(date,name,age,gender,address,phone,status,disease,room) values (?,?,?,?,?,?,?,?,?)";
            try {
...
//        pStatusField.setSelectedIndex(0);
    ...
    private void nextId() {
        connection = Connector.ConnectDb();
        if (connection != null) {
            String sql = "select `count`+1 as next_id from patient order by `count` desc limit 1;";
            try {
                prp = connection.prepareStatement(sql);
                rs = prp.executeQuery();
                int nextId = 0;
                ...
                pIdField.setText(String.valueOf(nextId));
